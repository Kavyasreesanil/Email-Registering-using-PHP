    ...
    if (isset($_POST['signup'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if(!preg_match("/^[0-9]+$/",$mobile)) {
                $mobile_error = "Mobile number must be numeric.";
                $error=true;
            }  
            if(strlen($mobile) < 10) {
...
<div class="page-header" >
            <h2 style="color:#fff">Email Registration Form</h2>
            ...
            <div class="col-lg-8 col-offset-2">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        ...
                        <span class="text-danger_"><?php if (isset($name_error)) echo $name_error; ?></span>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Mobile</label>
                        <input id="input_" type="number" name="mobile" class="form-control" value="" maxlength="12" required="">
